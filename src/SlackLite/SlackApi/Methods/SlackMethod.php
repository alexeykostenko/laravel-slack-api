...
use SlackLite\SlackApi\Contracts\SlackApi;
use Carbon\Carbon;
...
abstract class SlackMethod
{
    ...
    /**
     * @var \SlackLite\SlackApi\Contracts\SlackApi
     */
    protected $api;
    ...
    protected $cachePrefix = '__dss_slack_lite__';

    /**
     * @param \SlackLite\SlackApi\Contracts\SlackApi  $api
     * @param Cache $cache
     */
    ...
    /**
     * Returns the api.
     * @return \SlackLite\SlackApi\Contracts\SlackApi
     */
